...
     }
	...
	else if (chartview.viewtype == 'so2') {
	var so2data = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'no2') {
	var no2data = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'pm25') {
	var pm25data = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'temp') {
		var tempdata = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'heart') {
	 var heartdata = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'coaqi') {
	 var coaqidata = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'so2aqi') {
	 var so2aqidata = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'no2aqi') {
	 var no2aqidata = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'o3aqi') {
	 var o3aqidata = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'pm25aqi') {
	 var pm25aqidata = {
	       labels: timestamp,
	       datasets: [
	         {
	...
	else if (chartview.viewtype == 'totalaqi') {
	 var totalaqidata = {
	       labels: timestamp,
	       datasets: [
	         {
